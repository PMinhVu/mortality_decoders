...
import VNWorldEastNeonatalMortality from '../../../assets/data/VN_World_East_Neonatal_Mortality.csv';
...
const BarChart = () => {
    ...
    useEffect(() => {
        ...
        // Assuming VNWorldEastNeonatalMortality is already parsed as an array of objects
        const data = VNWorldEastNeonatalMortality;
    ...
    return <svg ref={ref} width={700} height={600}></svg>;
};
