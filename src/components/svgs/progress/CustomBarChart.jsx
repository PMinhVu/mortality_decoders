...
import VNMortality from '../../../assets/data/New_VN_World_East_Mortality.csv';
import VNNeonatalMortality from '../../../assets/data/VN_World_East_Neonatal_Mortality.csv';
...
const CustomBarChart = () => {
    ...
    useEffect(() => {
            ...
            indicatorType.forEach((type) => {
                ...
                if (dataPoint) {
                    ...
                    svg.append(type === indicatorType[0] ? 'circle' : 'rect')
                        ...
                        .attr(
                            'transform',
                            `translate(${type === indicatorType[1] ? -5 : 0},${type === indicatorType[1] ? -5 : 0})`,
                        )
                        .transition()
                        .duration(1000)
        ...
        svg.append('text')
            ...
            .text('Comparative Neonatal and 1-4 Age Groups Mortality Rates');
        svg.append('text')
            .attr('x', width / 2)
            ...
            .attr('font-size', '18px')
            .attr('font-weight', 'bold')
            .text('in Vietnam, East Asia and Pacific, and the World');
