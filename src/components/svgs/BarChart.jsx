...
const IndicatorDistributionBarGraph = () => {
    ...
    useEffect(() => {
        ...
        d3.csv('src/assets/data/mortality_for_all.csv').then((data) => {
            ...
            // Set up scales
            const x = d3.scaleBand().domain(indicators).range([margin.left, width - margin.right]).padding(0.2);
            ...
            svg.selectAll('.bar')
                ...
                .on('mouseover', function(event, d) {
                    d3.select(this)
                        ...
                        tooltip.html(`<strong>${d}</strong><br>Value: ${indicatorData.get(d).toFixed(2)}`)
